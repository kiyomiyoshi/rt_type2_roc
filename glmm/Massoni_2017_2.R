...
for (i in 0:2) {
  ...
  h1 <- c(rev(table(dat[which(dat$Response == 2 & dat$Stimulus == 2), "logit_bin"])),
          table(dat[which(dat$Response == 1 & dat$Stimulus == 2), "logit_bin"]))
  f1 <- c(rev(table(dat[which(dat$Response == 2 & dat$Stimulus == 1), "logit_bin"])),
