...
df1 <- foreach(i = 1:length(unique(dat$Subj_idx)), .combine = "rbind", .packages = c("dplyr", "metaSDT")) %dopar% {
  ...
  # confidence
  nR_S1 <- c(sum(d$Stimulus == "1" & d$Response == "1" & d$Confidence == 6, na.rm = TRUE),
             ...
             sum(d$Stimulus == "1" & d$Response == "2" & d$Confidence == 5, na.rm = TRUE),
             sum(d$Stimulus == "1" & d$Response == "2" & d$Confidence == 6, na.rm = TRUE))
  
  nR_S2 <- c(sum(d$Stimulus == "2" & d$Response == "1" & d$Confidence == 6, na.rm = TRUE),
             sum(d$Stimulus == "2" & d$Response == "1" & d$Confidence == 5, na.rm = TRUE),
             sum(d$Stimulus == "2" & d$Response == "1" & d$Confidence == 4, na.rm = TRUE),
             ...
             sum(d$Stimulus == "2" & d$Response == "2" & d$Confidence == 5, na.rm = TRUE),
             sum(d$Stimulus == "2" & d$Response == "2" & d$Confidence == 6, na.rm = TRUE))
...
ggpairs(df[, c("dp", "mdp_conf", "mdp_rt", "mdp_logit")]) + xlim(-0.5, 3)